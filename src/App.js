                ...
                <div className="container">
                    <header>
                        ...
                        <nav className="nav-menu">
                            ...
                            <Link to="/checkout" style={{ color: '#dd6b20', fontWeight: 'bold' }}>Thanh toán ký số</Link>
                        </nav>
                        ...
                        <div className="header-controls">
                            ...
                            <Link to="/checkout" className="cart-info" style={{ textDecoration: 'none', cursor: 'pointer' }}>
                        ...
                        {cart.length === 0 ? (
                            ...
                            <div>
                                    ...
                                    <div key={item.cartId} className="cart-item">
                                        ...
                                        <div className="cart-item-controls">
                                            <div className="quantity-control">
                                                <button onClick={() => updateQuantity(item.cartId, item.quantity - 1)} className="quantity-btn">-</button>
                                            ...
                                            <button onClick={() => removeFromCart(item.cartId)} className="remove-btn">Xóa</button>
                                        </div>
                                    </div>
                                ))}
                                <div className="total">
                                ...
                                <div className="cart-actions">
                                    ...
                                    <Link to="/checkout" className="checkout-btn-link" style={{ textDecoration: 'none', display: 'block', width: '100%', marginTop: '10px' }}>
                                        <button className="checkout" style={{ width: '100%', cursor: 'pointer' }} disabled={cart.length === 0}>Thanh toán ký số</button>
                                    </Link>
                                </div>
                            </div>
                        )}
